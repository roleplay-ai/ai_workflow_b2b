            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 5 }}>
              ...
              <div style={{ position: "relative" }}>
                <input
                  ...
                  style={{ ...inputBase, paddingRight: 42, borderColor: focused === "password" ? "#623CEA" : "#E5DFD8", boxShadow: focused === "password" ? "0 0 0 3px rgba(98,60,234,.09)" : "none" }}
                />
                <button
                  type="button"
                  onClick={() => setShowPassword(v => !v)}
                  style={{ position: "absolute", right: 12, top: "50%", transform: "translateY(-50%)", background: "none", border: "none", cursor: "pointer", padding: 2, color: "#9E98A6", display: "flex", alignItems: "center" }}
