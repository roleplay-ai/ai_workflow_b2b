...
export default function WorkflowsClient({ activities, toolLogos, tagLogos, userId, viewCounts, completedIds, inProgressIds, savedWorkflowIds, totalAvailable, completedCount, inProgressCount, userTotalPoints, companyPercentile, companySize, companyAvgPoints, modules, categoryThumbnails, categoryDescriptions, workflowsConfirmed: workflowsConfirmedInitial }: Props) {
